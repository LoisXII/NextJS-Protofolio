...
export default function gallery() {
    return <>
        <Head>
            <title>Loai: Gallery Photos</title>
        </Head>
                ...
                <div className="gallerytopsec">
                    <div className="topphonesec">
                        <div className="lefttitlesec">
                            <h4 data-aos="fade-right">Loai GALLARY PHOTOS</h4>
                            <h1 data-aos="fade-right">Loai <br /> Photographes</h1>
            ...
            <div className="gallerybtmphotos" id="galleryimages">
                <div className="container">
                    <div className="gbtmtitles text-center">
                        ...
                        <h2>Loai captures <span>All of Your</span> <br /> beautiful memories</h2>
                    </div>
